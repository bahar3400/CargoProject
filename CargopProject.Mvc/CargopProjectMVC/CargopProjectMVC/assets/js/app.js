            ...
            switch (e["data-layout-mode"]) {
                ...
                default:
                    sessionStorage.getItem("data-layout-mode") && "dark" == sessionStorage.getItem("data-layout-mode")
                        ? (sessionStorage.setItem("data-layout-mode", "dark"), document.documentElement.setAttribute("data-layout-mode", "dark"), T("data-layout-mode", "dark"))
                        : (sessionStorage.setItem("data-layout-mode", "light"), document.documentElement.setAttribute("data-layout-mode", "light"), T("data-layout-mode", "light"));
            }
                ...
                t.addEventListener("change", function () {
                    ...
                    document.documentElement.setAttribute(a, t.value),
                        ...
                        ("vertical" == t.value
                            ...
                            : "horizontal" == t.value
                                ? (document.getElementById("sidebarimg-none") && document.getElementById("sidebarimg-none").click(), k("horizontal"), feather.replace())
                                : "twocolumn" == t.value && (k("twocolumn"), document.documentElement.setAttribute("data-layout-width", "fluid"), document.getElementById("layout-width-fluid").click(), h(), A(), f(), feather.replace())),
        ...
        Array.from(m).forEach(function (e) {
            ...
            "flatpickr" == e.getAttribute("data-provider")
                ? ((o = e.attributes),
                    ...
                    o["data-date-format"] && (t.dateFormat = o["data-date-format"].value.toString()),
